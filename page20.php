...
<body>
    ...
    <?php
     ...
     // Requête SQL pour récupérer les informations des membres
$sql = "SELECT Username, Email, Age FROM utilisateurs";
$result = $con->query($sql);

if ($result->num_rows > 0) {
    echo "<table>";
    echo "<tr><th>Nom d'utilisateur</th><th>Email</th><th>Âge</th></tr>";
